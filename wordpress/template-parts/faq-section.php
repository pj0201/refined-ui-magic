    ...
    <div class="max-w-4xl mx-auto fade-in">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white/80 border border-gray-200/20 backdrop-blur-sm hover:bg-white/90 transition-all duration-300 rounded-lg p-6 shadow-lg">
                ...
                <p>これまでにも経営陣や幹部の皆様を対象に、要望に応じたオーダー型の研修や勉強会を行っております。『 事業計画の作り方 』『 営業計画の作り方 』『 営業戦略の策定 』『 補助金活用 』『 AI スキル習得 』『 顧客調査 』『 市場調査 』などの実績がございます。内容につきましては、ヒヤリングをさせていただき、ご要望に応じた研修メニューをご提案させていただきます。</p>
            </div>
            ...
            <div class="bg-white/80 border border-gray-200/20 backdrop-blur-sm hover:bg-white/90 transition-all duration-300 rounded-lg p-6 shadow-lg">
                ...
                <p>ご訪問以外にオンライン相談を取り入れて全国対応いたします。（北海道・関東一円・関西・中国・九州地域にて支援した実績あり）神戸・兵庫を拠点としていますが、地方企業の支援も積極的に行っています。</p>
            </div>
