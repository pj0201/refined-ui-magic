      ...
      <div className="relative z-10 text-center text-white space-y-12 px-4 -mt-20">
        ...
        <div className="space-y-6 flex flex-col items-center">
          ...
          <p className="text-4xl font-medium tracking-wide fade-in delay-100 backdrop-blur-sm bg-white/10 py-3 px-6 rounded-lg">
            PLANNING<span className="text-red-500 font-extrabold text-5xl scale-x-200" style={{ fontFamily: "'Noto Serif JP', serif", fontWeight: 900, display: 'inline-block', transform: 'scaleX(2)' }}>J</span>OY株式会社
          </p>
        </div>
      </div>
    </section>
