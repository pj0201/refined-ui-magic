        ...
        <div className="max-w-4xl mx-auto fade-in">
          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent>
                これまでにも経営陣や幹部の皆様を対象に、要望に応じたオーダー型の研修や勉強会を行っております。『 事業計画の作り方 』『 営業計画の作り方 』『 営業戦略の策定 』『 補助金活用 』『 AI スキル習得 』『 顧客調査 』『 市場調査 』などの実績がございます。内容につきましては、ヒヤリングをさせていただき、ご要望に応じた研修メニューをご提案させていただきます。
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
